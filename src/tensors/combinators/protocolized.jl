...
unwrap_outer(ctx, arr::VirtualProtocolizedArray, mode, protos) =
    VirtualProtocolizedArray(unwrap_outer(ctx, arr.body, mode, map(something, arr.protos, protos)), arr.protos)
