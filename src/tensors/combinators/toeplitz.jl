...
unfurl_prehook(ctx, arr::VirtualToeplitzArray, mode, protos) =
    VirtualToeplitzArray(unfurl_prehook(ctx, arr.body, mode, [protos[1:arr.dim]; protos[arr.dim + 2:end]]), arr.dim)
