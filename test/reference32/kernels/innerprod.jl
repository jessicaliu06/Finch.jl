begin
            ...
            if phase_stop >= 1
                ...
                while k <= phase_stop
                    ...
                    if A_lvl_2_i == phase_stop_2 && A_lvl_2_i_2 == phase_stop_2
                        ...
                        B_lvl_2dirty = true
                        B_lvl_2_val[B_lvl_2_qos] = A_lvl_3_val_2 * A_lvl_3_val + B_lvl_2_val[B_lvl_2_qos]
                        A_lvl_2_q += 1
                        A_lvl_2_q_2 += 1
    ...
    (B = Tensor((DenseLevel){Int32}((SparseListLevel){Int32}(B_lvl_3, A_lvl.shape, B_lvl_ptr, B_lvl_idx), A_lvl.shape)),)
end
