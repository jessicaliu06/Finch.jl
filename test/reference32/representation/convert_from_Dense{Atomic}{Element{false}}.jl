quote
    ...
    for i_4 = 1:tmp_lvl_2.shape
        ...
        tmp_lvl_2_q = (1 - 1) * tmp_lvl_2.shape + i_4
        tmp_lvl_3_val = tmp_lvl_2_val[tmp_lvl_2_q]
        res = (res_lvl_val[res_lvl_qos] = tmp_lvl_3_val)
    ...
    (res = Tensor((SparseListLevel){Int32}(res_lvl_2, tmp_lvl_2.shape, res_lvl_ptr, res_lvl_idx)),)
end
