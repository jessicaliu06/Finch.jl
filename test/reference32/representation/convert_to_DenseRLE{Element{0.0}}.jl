quote
    ...
    Finch.fill_range!(tmp_lvl_val, 0.0, 1, tmp_lvl_qos_stop)
    q = 1
    q_2 = 1
    for p_2 = 1:1
    ...
    (tmp = Tensor((RunListLevel){Int32}(tmp_lvl_2, ref_lvl.shape, tmp_lvl_ptr, tmp_lvl_right, tmp_lvl_3; merge = true)),)
end
