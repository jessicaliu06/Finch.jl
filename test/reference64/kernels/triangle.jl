            ...
            while true
                ...
                if A_lvl_2_i < phase_stop
                    ...
                    if A_lvl_2_i == phase_stop_8
                        ...
                        A_lvl_2_q_4 = A_lvl_ptr[A_lvl_q_2]
                        A_lvl_2_q_stop_4 = A_lvl_ptr[A_lvl_q_2 + 1]
                        if A_lvl_2_q_4 < A_lvl_2_q_stop_4
                            A_lvl_2_i1_4 = A_lvl_idx[A_lvl_2_q_stop_4 - 1]
                        else
                            A_lvl_2_i1_4 = 0
                        end
                        A_lvl_2_q_5 = A_lvl_ptr[A_lvl_q_3]
                        A_lvl_2_q_stop_5 = A_lvl_ptr[A_lvl_q_3 + 1]
                        if A_lvl_2_q_5 < A_lvl_2_q_stop_5
                            A_lvl_2_i1_5 = A_lvl_idx[A_lvl_2_q_stop_5 - 1]
                        else
                            A_lvl_2_i1_5 = 0
                        end
                        phase_stop_9 = min(A_lvl_2.shape, A_lvl_2_i1_4, A_lvl_2_i1_5)
                        if phase_stop_9 >= 1
                            k = 1
                            if A_lvl_idx[A_lvl_2_q_4] < 1
                                A_lvl_2_q_4 = Finch.scansearch(A_lvl_idx, 1, A_lvl_2_q_4, A_lvl_2_q_stop_4 - 1)
                            end
                            if A_lvl_idx[A_lvl_2_q_5] < 1
                                A_lvl_2_q_5 = Finch.scansearch(A_lvl_idx, 1, A_lvl_2_q_5, A_lvl_2_q_stop_5 - 1)
                            end
                            while k <= phase_stop_9
                                A_lvl_2_i_4 = A_lvl_idx[A_lvl_2_q_4]
                                A_lvl_2_i_5 = A_lvl_idx[A_lvl_2_q_5]
                                phase_stop_10 = min(A_lvl_2_i_5, phase_stop_9, A_lvl_2_i_4)
                                if A_lvl_2_i_4 == phase_stop_10 && A_lvl_2_i_5 == phase_stop_10
                                    A_lvl_3_val_6 = A_lvl_2_val[A_lvl_2_q_4]
                                    A_lvl_3_val_7 = A_lvl_2_val[A_lvl_2_q_5]
