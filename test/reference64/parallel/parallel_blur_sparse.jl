    ...
    Threads.@threads for tid = 1:n
            Finch.@barrier begin
                    @inbounds @fastmath(begin
                                ...
                                input_lvl_2_ptr_3 = (Finch).transfer(Finch.CPUThread(tid, Finch.CPU(n), Serial()), input_lvl_2_ptr_2)
                                input_lvl_2_idx_3 = (Finch).transfer(Finch.CPUThread(tid, Finch.CPU(n), Serial()), input_lvl_2_idx_2)
