begin
    ...
    input_lvl_2_ptr_2 = (Finch).transfer(CPUSharedMemory(cpu), input_lvl_2_ptr)
    input_lvl_2_idx_2 = (Finch).transfer(CPUSharedMemory(cpu), input_lvl_2_idx)
    ...
    Threads.@threads for tid = 1:cpu.n
            Finch.@barrier begin
                    @inbounds @fastmath(begin
                                ...
                                input_lvl_2_ptr_3 = (Finch).transfer(CPUThread(tid, cpu, Serial()), input_lvl_2_ptr_2)
                                input_lvl_2_idx_3 = (Finch).transfer(CPUThread(tid, cpu, Serial()), input_lvl_2_idx_2)
