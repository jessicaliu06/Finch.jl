quote
        ...
        while true
            ...
            if ref_lvl_i < phase_stop
                ...
                if tmp_lvl_qos > tmp_lvl_qos_stop
                    ...
                    Finch.fill_range!(tmp_lvl_val, 0.0, tmp_lvl_qos, tmp_lvl_qos_stop)
                end
    ...
    (tmp = Tensor((SparseBlockListLevel){Int64}(tmp_lvl_2, ref_lvl.shape, tmp_lvl_ptr, tmp_lvl_idx, tmp_lvl_ofs)),)
end
